...
public class BrickBreakerGame extends JPanel implements KeyListener, ActionListener, MouseListener, MouseMotionListener
{
    ...
    private Image StartImage = ImageLoader.loadImage("Resources/Start.png");
    private Image LogoImage = ImageLoader.loadImage("Resources/Logo.png");
    private Image OptionImage = ImageLoader.loadImage("Resources/Option.png");

    //Images for Mode Screen
    private Image ClassicModeImage = ImageLoader.loadImage("Resources/Classic Mode Button.png");
    private Image MayhemModeImage = ImageLoader.loadImage("Resources/3Ball Mode Button.png");
    private Image ExplosiveBrickModeImage = ImageLoader.loadImage("Resources/Explosive Mode Button.png");

    //Images for Game Screen

    //Images for Option Screen
    private Image ExitImage = ImageLoader.loadImage("Resources/Exit Button.png");
    private Image UpArrowImage = ImageLoader.loadImage("Resources/UpArrow.png");
    private Image DownArrowImage = ImageLoader.loadImage("Resources/DownArrow.png");
    private Image ResetButtonImage = ImageLoader.loadImage("Resources/Reset Button.png");

    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Objects for Menu Screen
    private Button startButton, OptionButton;

    //Objects for Mode Screen
    private Button ClassicModeButton, MayhemModeButton, ExplosiveModeButton;
    private String GameMode;
    private String[] GameModeArray = {"Classic", "Mayhem", "Explosive", "Inverse", "Dodge", "Invisible"};
    ...
    private Ball[] MayhemBallArray = new Ball[3];
    ...
    private ToggleButton RPaddleSelected, LPaddleSelected, RBrickSelected, LBrickSelected;
    private Button UpButtonRed, UpButtonGreen, UpButtonBlue, DownButtonRed, DownButtonBlue, DownButtonGreen;
    private Button UpDecayRate, DownDecayRate;
    private Button UpScoreToWin, DownScoreToWin;
    private Button UpSuddenDeathLimit, DownSuddenDeathLimit;
    private Button UpGameTime, DownGameTime;
    private ToggleButton suddenDeathOn;
    private ToggleButton BallColorSelected;
    private Button resetButton;
    private ToggleButton RightBotButton, LeftBotButton;
    ...
    private void GameScreen(Graphics g)// Screen == 2// scores and painting the background
    {
        ...
        if(RoundTime-TimerCounter < 0&&playerRight.getBrickCount()>suddenDeathLimit&&playerLeft.getBrickCount()>suddenDeathLimit&& suddenDeathOn.getState())
        {
            ...
            else if(GameMode.equals("Mayhem")){
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////movement
            ...
            else if(GameMode.equals("Explosive")){
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////movement
                ball1.CheckCollidesWith(playerLeft.getPaddle());
                ball1.CheckCollidesWith(playerRight.getPaddle());
                ball1.CheckCollidesWith(playerRight.getBrickList());
